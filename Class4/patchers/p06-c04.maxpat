...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 278.0, 155.0, 37.0 ],
					"presentation_linecount" : 2,
					"text" : "Look how easy it is to add polyphony in RNBO"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 173.5, 152.0, 51.0 ],
					"presentation_linecount" : 3,
					"text" : "You have to do a little dance to support MIDI in RNBO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 154.0, 46.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 210.0, 188.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 119.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 42.0, 336.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 85.0, 314.0, 48.0, 82.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 137.0, 351.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 160.0, 152.0, 78.0 ],
					"text" : "We haven't seen the midiformat object yet, but it turns Max \"MIDI\" messages into true MIDI bytes"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 67.5, 397.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
,
									"fileref" : 									{
										"name" : "my-first-rnbo",
										"filename" : "my-first-rnbo_20240212_2.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "4ffa2a1dc756e9d7651bba4725b688cc"
									}
...
, 								{
									...
									"fileref" : 									{
										"name" : "simple-synth",
										"filename" : "simple-synth.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "defe942346394a9fceff7cb4b4e2c81a"
									}
...
,
					"text" : "rnbo~ @title simple-synth @polyphony 20",
					"varname" : "rnbo~[1]"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "my-first-rnbo_20240212_2.maxsnap",
