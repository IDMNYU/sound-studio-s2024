...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 263.0, 150.0, 37.0 ],
					"text" : "Now with a little bit of tremolo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 85.0, 162.0, 41.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.0, 228.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 179.0, 46.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 315.0, 213.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 144.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 67.0, 336.0, 53.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 425.0, 406.5, 148.0, 68.0 ],
									"presentation_linecount" : 4,
									"text" : "Smoothing to avoid zipper noise, notice the keepramp attribute which is RNBO only"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 409.0, 291.0, 150.0, 97.0 ],
									"presentation_linecount" : 6,
									"text" : "Getting a little bit fancy here, using a single parameter to modulate two different properties: the tremolo rate and depth"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 67.0, 597.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
,
					"patching_rect" : [ 85.0, 270.5, 249.0, 22.0 ],
					"rnboattrcache" : 					{
						"tremolo" : 						{
							"label" : "tremolo",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										"name" : "my-first-rnbo",
										"filename" : "my-first-rnbo_20240212_3.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "9e13b62eb8ad0cf66dd4850707e0f4ad"
									}
...
,
									"fileref" : 									{
										"name" : "simple-synth",
										"filename" : "simple-synth_20240212.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "9921237dc58589f47dff90466a8e26a1"
									}
...
,
					"text" : "rnbo~ @title simple-synth-02 @polyphony 20",
					"varname" : "rnbo~[1]"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "my-first-rnbo_20240212_3.maxsnap",
...
, 			{
				"name" : "simple-synth_20240212.maxsnap",
				"bootpath" : "~/Documents/Max 8/Snapshots",
				"patcherrelativepath" : "../../../../Documents/Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
