...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 42.5, 152.0, 37.0 ],
					"text" : "pictslider is a great 2d controller"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 170.0, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 259.0, 170.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 392.0, 138.0, 39.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 259.0, 138.0, 39.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.0, 18.0, 100.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 88.0, 243.0, 32.0, 22.0 ],
					"text" : "+ 60"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 510.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 88.0, 355.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 388.0, 300.0, 100.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, "C74_AU:/DLSMusicDevice", ";" ],
...
,
					"snapshot" : 					{
						...
						"snapshot" : 						{
							...
							"pluginsavedname" : "C74_AU:/DLSMusicDevice",
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "6570c4a4b00b9c7f12cebe1a910d82cb"
									}
...
,
					"text" : "vst~ C74_AU:/DLSMusicDevice",
					"varname" : "vst~",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 88.0, 137.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 326.0, 46.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 288.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 178.0, 66.0, 22.0 ],
					"text" : "random 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 88.0, 66.0, 63.0, 22.0 ],
					"text" : "metro 250"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 88.0, 28.0, 24.0, 24.0 ]
				}
