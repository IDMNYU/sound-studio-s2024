...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 208.0, 319.0, 32.0, 22.0 ],
					"text" : "+ 60"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 267.5, 150.0, 51.0 ],
					"text" : "Use a smaller range, makes it a little bit less random"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 267.0, 29.5, 22.0 ],
					"text" : "60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 88.0, 175.0, 50.0, 22.0 ],
					"text" : "select 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 88.0, 106.0, 61.0, 22.0 ],
					"text" : "counter 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 705.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 88.0, 550.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 583.0, 300.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 208.0, 242.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 132.0, 28.0, 149.0, 24.0 ],
					"size" : 200.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 521.0, 46.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 483.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 282.0, 66.0, 22.0 ],
					"text" : "random 20"
				}
