...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.0, 226.5, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1211.0, 441.5, 29.5, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 864.0, 36.5, 250.0, 143.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1221.0, 217.5, 125.0, 115.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 864.0, 217.5, 315.0, 196.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 865.0, 715.5, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1066.0, 726.5, 184.0, 68.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 907.0, 663.5, 60.0, 22.0 ],
					"text" : "clip~ 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 907.0, 602.5, 168.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 907.0, 578.5, 35.0, 22.0 ],
					"text" : "abs~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 907.0, 545.5, 29.5, 22.0 ],
					"text" : "-~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 121.0, 369.0, 313.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 473.0, 226.0, 153.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 864.0, 753.5, 136.0, 47.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 310.0, 657.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 310.0, 430.0, 29.5, 22.0 ],
									"text" : "$2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 430.0, 59.0, 22.0 ],
									"text" : "$1, $2 $3"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 509.0, 34.0, 22.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 15.0, 609.0, 132.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 17.0, 657.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 24.5, 644.0, 26.5, 644.0 ],
									"source" : [ "obj-2", 0 ]
								}
...
,
					"patching_rect" : [ 864.0, 497.5, 104.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 864.0, 462.5, 52.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 304.0, 261.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 679.0, 304.0, 167.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.0, 224.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 121.0, 144.0, 152.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 184.0, 202.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 864.0, 823.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 231.0, 264.0, 615.0, 23.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 482.5, 255.5, 240.5, 255.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 263.5, 176.5, 130.5, 176.5 ],
					"source" : [ "obj-9", 1 ]
				}
		...
		"parameters" : 		{
			...
			"obj-1::obj-177" : [ "refresh", "refresh", 0 ],
			...
			"obj-1::obj-81" : [ "midiout", "midiout", 0 ],
			"obj-1::obj-85" : [ "live.toggle", "live.toggle", 0 ],
			"obj-1::obj-98" : [ "live.toggle[1]", "live.toggle", 0 ],
			"obj-1::obj-99" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-25::obj-11" : [ "beats", "beats", 0 ],
			"obj-25::obj-113" : [ "volume", "vol", 0 ],
			"obj-25::obj-137" : [ "pulse[1]", "pulse[1]", 0 ],
			"obj-25::obj-15" : [ "click-state", "click-state", 0 ],
			"obj-25::obj-23" : [ "timesig-beats", "timesig-beats", 0 ],
			"obj-25::obj-26" : [ "timesig-unit", "timesig-unit", 0 ],
			"obj-25::obj-42" : [ "transport state", "transport state", 0 ],
			"obj-25::obj-45" : [ "reset", "reset", 0 ],
			"obj-25::obj-48" : [ "taptotempo", "taptotempo", 0 ],
			"obj-25::obj-578" : [ "bpm", "bpm", 0 ],
			"obj-25::obj-9" : [ "bars", "bars", 0 ],
