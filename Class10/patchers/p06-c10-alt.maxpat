...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 292.0, 474.0, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 292.0, 387.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 292.0, 437.0, 86.0, 22.0 ],
					"text" : "record~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 349.0, 367.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 876.0, 456.0, 38.0, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 925.0, 378.0, 47.0, 22.0 ],
					"text" : "pack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 925.0, 414.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 580.0, 456.0, 100.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 580.0, 228.0, 315.0, 196.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1147.0, 333.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 925.0, 333.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1147.0, 294.0, 39.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 925.0, 294.0, 39.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1147.0, 59.0, 208.0, 191.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 925.0, 59.0, 208.0, 191.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 580.0, 59.0, 250.0, 143.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 139.0, 25.0, 161.0, 57.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 28.0, 143.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 139.0, 148.0, 229.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 108.0, 94.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "fluid.list2buf @destination query @autosize 0"
								}
...
,
					"patching_rect" : [ 49.0, 635.0, 49.0, 22.0 ],
...
,
					"patching_rect" : [ 49.0, 344.0, 196.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 159.0, 60.0, 95.0, 22.0 ],
									"text" : "knearest 0.5 0.5"
								}
...
,
					"patching_rect" : [ 49.0, 302.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 49.0, 261.0, 139.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 49.0, 216.0, 62.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 261.0, 800.0, 29.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 303.0, 691.0, 60.0, 22.0 ],
									"text" : "clip~ 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 303.0, 630.0, 168.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 303.0, 606.0, 35.0, 22.0 ],
									"text" : "abs~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 303.0, 573.0, 29.5, 22.0 ],
									"text" : "-~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 451.0, 551.0, 29.5, 22.0 ],
									"text" : "$2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 156.0, 551.0, 59.0, 22.0 ],
									"text" : "$1, $2 $3"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 156.0, 630.0, 34.0, 22.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 156.0, 411.0, 38.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 156.0, 482.0, 39.0, 22.0 ],
									"text" : "join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 156.0, 730.0, 74.0, 22.0 ],
									"text" : "play~ sound"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 261.0, 838.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 185.5, 472.0, 185.5, 472.0 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 185.0, 436.0, 185.5, 436.0 ],
									"source" : [ "obj-8", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 165.5, 436.0, 165.5, 436.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 49.0, 687.0, 66.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 49.0, 173.0, 52.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 49.0, 387.0, 192.0, 192.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 205.0, 216.0, 326.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 929.0, 55.0, 22.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 49.0, 776.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 372.0, 148.0, 189.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 88.5, 673.0, 248.0, 673.0, 248.0, 379.0, 58.5, 379.0 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 885.5, 611.0, 58.5, 611.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 58.5, 926.0, 94.5, 926.0 ],
					"order" : 0,
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 58.5, 914.0, 58.5, 914.0 ],
					"order" : 1,
					"source" : [ "obj-54", 0 ]
				}
		...
		"parameters" : 		{
			"obj-16::obj-11" : [ "rslider", "rslider", 0 ],
			"obj-16::obj-2" : [ "speed", "speed", 0 ],
			"obj-16::obj-27" : [ "waveshape", "waveshape", 0 ],
			"obj-16::obj-3" : [ "output", "output", 0 ],
			"obj-18::obj-11" : [ "rslider[1]", "rslider", 0 ],
			"obj-18::obj-2" : [ "speed[1]", "speed", 0 ],
			"obj-18::obj-27" : [ "waveshape[1]", "waveshape", 0 ],
			"obj-18::obj-3" : [ "output[1]", "output", 0 ],
			"obj-35::obj-11" : [ "beats", "beats", 0 ],
			"obj-35::obj-113" : [ "volume", "vol", 0 ],
			"obj-35::obj-137" : [ "pulse[1]", "pulse[1]", 0 ],
			"obj-35::obj-15" : [ "click-state", "click-state", 0 ],
			"obj-35::obj-23" : [ "timesig-beats", "timesig-beats", 0 ],
			"obj-35::obj-26" : [ "timesig-unit", "timesig-unit", 0 ],
			"obj-35::obj-42" : [ "transport state", "transport state", 0 ],
			"obj-35::obj-45" : [ "reset", "reset", 0 ],
			"obj-35::obj-48" : [ "taptotempo", "taptotempo", 0 ],
			"obj-35::obj-578" : [ "bpm", "bpm", 0 ],
			"obj-35::obj-9" : [ "bars", "bars", 0 ],
			"obj-37::obj-100" : [ "SetPitch_1[1]", "live.numbox", 0 ],
			"obj-37::obj-102" : [ "live.toggle[5]", "live.toggle", 0 ],
			"obj-37::obj-103" : [ "live.toggle[4]", "live.toggle", 0 ],
			"obj-37::obj-11" : [ "beam", "beam", 2 ],
			"obj-37::obj-133" : [ "scales", "scales", 2 ],
			"obj-37::obj-139::obj-111" : [ "number[5]", "number", 0 ],
			"obj-37::obj-14" : [ "probability-one[11]", "probability-one", 0 ],
			"obj-37::obj-145" : [ "root", "root", 0 ],
			"obj-37::obj-177" : [ "refresh", "refresh", 0 ],
			"obj-37::obj-29" : [ "probability-zero[13]", "probability-zero", 0 ],
			"obj-37::obj-3" : [ "probability-zero[11]", "probability-zero", 0 ],
			"obj-37::obj-318" : [ "Velocity_1[1]", "live.numbox[11]", 0 ],
			"obj-37::obj-34" : [ "live.text", "live.text", 0 ],
			"obj-37::obj-43" : [ "probability-one[2]", "probability-one", 0 ],
			"obj-37::obj-50::obj-14" : [ "probability-one[1]", "probability-one", 0 ],
			"obj-37::obj-50::obj-29" : [ "probability-zero[1]", "probability-zero", 0 ],
			"obj-37::obj-63" : [ "RandomNoteValue_1[1]", "live.text", 0 ],
			"obj-37::obj-72" : [ "probability-zero[12]", "probability-zero", 0 ],
			"obj-37::obj-73" : [ "probability-one[10]", "probability-one", 0 ],
			"obj-37::obj-7::obj-14" : [ "probability-one[12]", "probability-one", 0 ],
			"obj-37::obj-7::obj-29" : [ "probability-zero[10]", "probability-zero", 0 ],
			"obj-37::obj-8" : [ "probability-one[13]", "probability-one", 0 ],
			"obj-37::obj-81" : [ "midiout", "midiout", 0 ],
			"obj-37::obj-85" : [ "live.toggle[3]", "live.toggle", 0 ],
			"obj-37::obj-98" : [ "live.toggle[1]", "live.toggle", 0 ],
			"obj-37::obj-99" : [ "live.toggle[2]", "live.toggle", 0 ],
