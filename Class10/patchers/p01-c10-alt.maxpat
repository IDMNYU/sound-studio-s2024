...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 108.0, 229.0, 20.0 ],
					"text" : "Alternate technique, using novelty slicing."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 275.0, 226.0, 189.5, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 231.0, 264.0, 695.0, 23.0 ],
					"text" : "fluid.bufnoveltyslice~ @source help.bufonset.src @indices help.bufonset.slices @maxfiltersize 71 @maxkernelsize 101"
				}
