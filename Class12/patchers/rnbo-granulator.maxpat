...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 83.0, 150.0, 47.0 ],
					"text" : "Good starting point for patches dealing with granular synthesis."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 176.0, 93.0, 60.0 ],
					"presentation_linecount" : 4,
					"text" : "(msec but careful, granulator wants samples)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 678.0, 180.0, 59.0, 52.0 ],
					"text" : "Pan (0-1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 603.0, 180.0, 60.0, 39.0 ],
					"text" : "Channel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 502.0, 180.0, 63.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 180.0, 54.0, 52.0 ],
					"presentation_linecount" : 2,
					"text" : "Grain length"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 176.0, 93.0, 60.0 ],
					"text" : "(msec but careful, granulator wants samples)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 180.0, 50.0, 52.0 ],
					"presentation_linecount" : 2,
					"text" : "Grain Start "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 180.0, 50.0, 52.0 ],
					"text" : "Grain Rate"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Easy granulator with RNBO"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 502.0, 243.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 603.0, 335.0, 41.0, 22.0 ],
					"text" : "sig~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 157.0, 284.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 157.0, 243.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 157.0, 335.0, 77.0, 22.0 ],
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 331.0, 335.0, 77.0, 22.0 ],
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 678.0, 335.0, 51.0, 22.0 ],
					"text" : "sig~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 502.0, 335.0, 41.0, 22.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 656.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 145.0, 495.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 73.0, 335.0, 43.0, 22.0 ],
					"text" : "<~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 74.0, 284.0, 62.0, 22.0 ],
					"text" : "phasor~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 481.0, 83.0, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 481.0, 42.0, 75.0, 22.0 ],
					"text" : "buffer~ track"
				}
...
,
					"patching_rect" : [ 145.0, 449.0, 104.0, 22.0 ],
					"rnboattrcache" : 					{
