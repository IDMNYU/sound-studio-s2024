...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 461.0, 161.0, 22.0 ],
					"priority" : 					{
...
,
					"text" : "pattrstorage 03-vsynth-audio",
					"varname" : "03-vsynth-audio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1047.0, 137.0, 134.0, 64.0 ],
					"text" : "Add a little bit of smoothing. Here, asymmetric so we slide down, not up."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1026.0, 71.0, 134.0, 37.0 ],
					"text" : "Scale the signal. Here we're inverting"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 991.0, 133.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.0, 71.0, 90.0, 22.0 ],
					"text" : "scale 0. 1. 1. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 924.0, 133.0, 53.0, 22.0 ],
					"text" : "slide 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 298.0, 184.0, 74.0, 22.0 ],
					"text" : "delay~ 4096"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 213.0, 184.0, 74.0, 22.0 ],
					"text" : "delay~ 4096"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 587.0, 256.0, 150.0, 51.0 ],
					"text" : "Higher exponents make peaks more peaky"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 422.0, 302.0, 44.0, 22.0 ],
					"text" : "pow 2."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 422.0, 383.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 498.0, 344.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 422.0, 248.0, 101.0, 22.0 ],
					"text" : "mc.peakamp~ 16"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 240.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 587.0, 169.0, 150.0, 51.0 ],
					"text" : "Multiplying by onsets really emphasizes the sound at an onset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 473.0, 166.0, 80.0, 22.0 ],
					"text" : "slide~ 1 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 498.0, 380.0, 184.0, 68.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 473.0, 132.0, 264.0, 23.0 ],
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 422.0, 71.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 30.5, 156.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1083.0, 368.0, 157.0, 22.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.0, 368.0, 146.0, 133.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 924.0, 216.0, 215.0, 100.0 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "03-vsynth-audio.json",
				"bootpath" : "~/cute/sound-studio-s2024/Class13/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
